const id = {
  ...
  evolution: {
    label: "Evolusi 11 Tahun",
    title: "Dari Ruang Ekspresi Menjadi Hub Ekosistem",
    items: [
      {
  ...
  statistic: {
    ...
    description:
      "Mengukur dampak nyata, memetakan pertumbuhan, dan membuka ruang integrasi terbesar bagi masa depan ekonomi kreatif.",
    items: [
      { label: "Pengunjung", value: "20.000+" },
      { label: "Pelaku Kreatif", value: "500+" },
      { label: "Business Matching", value: "300+" },
      { label: "Potensi Transaksi", value: "50 - 150 M" },
    ],
  },
  program: {
    label: "Program",
  ...
  agenda: {
    label: "Agenda",
    title: "Saat Kultur Bertemu Teknologi Terdepan.",
    description:
      "Satu stadion, ribu ide, juta karya, satu gerakan. Simak ringkasan agenda kolaborasi, eksibisi bisnis, hingga panggung sportainment spektakuler Festival Mbois 11.",
    comingSoonTitle: "Sesuatu yang Besar Sedang Disiapkan!",
    comingSoonSubtitle: "Nantikan kejutan besar sedang disiapkan.",
  },
  registration: {
    label: "Gerbang Ekosistem",
    title: "Pilih Peranmu Sekarang",
  ...
  partners: {
    ...
    governmentTitle: "Instansi Pemerintah & Kementerian",
    privateTitle: "Sektor Swasta & Mitra Bisnis",
  },
  faq: {
    label: "FAQs",
    ...
    items: [
      ...
      {
        title:
          "Bagaimana cara menghubungi pihak penyelenggara untuk pertanyaan lebih lanjut atau kerja sama?",
        content:
