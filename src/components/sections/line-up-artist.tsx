...
export default function LineUpArtist() {
  ...
  return (
    ...
    >
      <div className="pointer-events-none absolute z-20 inset-x-0 top-0 h-32 md:h-48">
      ...
      <div className="flex flex-col items-center gap-y-6 text-[#F2F2F2] relative z-20">
        ...
        <p className="w-full max-w-xl md:max-w-3xl lg:max-w-4xl text-center text-base text-[#F2F2F2]/80 sm:text-lg md:text-2xl">
      ...
      <div className="mx-auto mt-8 w-full max-w-lg md:max-w-4xl lg:max-w-6xl text-center text-xl text-[#FDFDFD] relative z-20">
