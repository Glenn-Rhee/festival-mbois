...
export default function StatistikSection() {
  return (
    <section
      id="statistik"
      className="bg-brand-navy relative w-full py-14 md:py-72 lg:py-[356px]"
    >
      {/* Background Glow */}
      ...
      <div className="max-w-8xl relative z-10 mx-auto w-full px-6 lg:px-[72px]">
        ...
        <div className="flex flex-col">
          {statisticsData.map((item, index) => (
            ...
            >
              <h3 className="text-neutral-off-white mb-2 text-base font-medium md:mb-0 md:text-lg lg:text-[28px]">
                {item.label}
              </h3>
              <div className="text-neutral-off-white text-5xl font-light tracking-tight md:text-6xl lg:text-[128px]">
                {item.value}
              </div>
            </div>
          ))}
